...
CONSUMER_KEY = 'gNkaOqMNbRgfIUaz2GBG2xeov'
CONSUMER_SECRET = 'XsgSFwsWc3KCuypZw916an5S6qBzARZrGr7S7QKQFywsIw7ume'
ACCESS_TOKEN = "3363266074-nyATkF4h6GGJLYbdxv3TC0VQdQb0T1Ryoloda4p"
ACCESS_TOKEN_SECRET = "h9lX8efTHo5c6Dvs2DMy8PjzjVMELlyiwNHWqsp6jfbfB"
twitter = Twython(CONSUMER_KEY, CONSUMER_SECRET,ACCESS_TOKEN, ACCESS_TOKEN_SECRET)


init("anXYtBAMUGMpnpVDV2RKSGfUmF2Kjn")#Pushoher kulanımı için...

print "#".ljust(30,"#")
webbrowser.open_new_tab("https://twitter.com/api_twiter")#webbrowserda hesabınızın otomatik açılması sağlar
k = PyQuery("https://twitter.com/api_twiter") 
print k('title').html()                       
print "#".ljust(30,"#")
